from src.numpy_polyfit import *
from src.generate_picture import *
from src.analytical_solution import *
from src.generate_loss_picture import *
from src.gradient_descent_solution import *
from src.conjugate_gradient_solution import *
...
def main():
    ...
    for i in range(11):
        ...
        梯度下降法，加惩罚项
        """
        gradient_descent_result_with_penalty, number = gradient_descent(train_X, train_Y, learning_rate, deviation,
                                                                        poly_degree, lam=0.01)
        generate_picture(train_X, train_Y, gradient_descent_result_with_penalty, 'gradient descent without penalty',
                         title)
        print(number)
        ...
        梯度下降法，不加惩罚项
        """
        gradient_descent_result_without_penalty, number = gradient_descent(train_X, train_Y, learning_rate, deviation,
                                                                           poly_degree, lam=0)
    ...
    # generate_loss_picture(x_array, loss_train_array, loss_test_array, data_number)
